...
print("backtesting use default param value : TRIMA fast 7, slow 17. Expectunity %.2f " %
      (combined_expectunity_calcuation("/Users/kevinmartin/Documents/Fall '20/GQP/Trading System/Kevin/result.csv", 100)))
