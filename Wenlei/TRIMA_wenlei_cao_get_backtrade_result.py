...
class TRIMA (bt.Strategy): 
    ...
    def __init__(self):
        ...
        sma1 = bt.talib.TRIMA(self.datas[0], timeperiod=self.params.pfast) # fast moving average
        sma2 = bt.talib.TRIMA(self.datas[0], timeperiod=self.params.pslow)  # slow moving average
...
data = bt.feeds.YahooFinanceCSVData(
        dataname=r'C:\Users\Wenlei\Desktop\GQP\VINIX_all.csv',
...
if __name__ == '__main__':
    ...
    print ('TRIMA param: pfast:%i, pslow:%i' % (TRIMA.params.pfast, TRIMA.params.pslow))
    #Run Cerebro Engine
